/**
 * Import-path aliases a consumer's project uses, mirroring the `aliases`
 * block of `hex.config.json`. Consumed by `rewriteRegistryImports` when
 * rewriting registry sources for a target project.
 */
