...
//
// Style reference inspired by Replicate's publicly visible design system.
// Hex Core is not affiliated with, endorsed by, or sponsored by Replicate.
...
export const replicateTheme: Theme = {
	name: "replicate",
	...
	tokens: {
		light: {
			...
			foreground: { value: "0 0% 12.5%", type: "color" },
			card: { value: "0 0% 100%", type: "color" },
			"card-foreground": { value: "0 0% 12.5%", type: "color" },
			popover: { value: "0 0% 100%", type: "color" },
			"popover-foreground": { value: "0 0% 12.5%", type: "color" },
			primary: { value: "9 96.6% 46.7%", type: "color" },
			"primary-foreground": { value: "240 10% 3.9%", type: "color" },
			secondary: { value: "9 5% 95.9%", type: "color" },
			"secondary-foreground": { value: "240 10% 3.9%", type: "color" },
			muted: { value: "9 5% 95.9%", type: "color" },
			"muted-foreground": { value: "0 0% 38%", type: "color" },
			accent: { value: "9 5% 95.9%", type: "color" },
			"accent-foreground": { value: "240 10% 3.9%", type: "color" },
			destructive: { value: "9 96.6% 46.7%", type: "color" },
			"destructive-foreground": { value: "240 10% 3.9%", type: "color" },
			border: { value: "0 0% 90%", type: "color" },
			input: { value: "0 0% 90%", type: "color" },
			ring: { value: "9 96.6% 46.7%", type: "color" },
			radius: { value: "2rem", type: "radius" },
			...sharedTokens,
		},
		dark: {
			background: { value: "0 0% 0%", type: "color" },
			foreground: { value: "0 0% 87.5%", type: "color" },
			card: { value: "0 0% 0%", type: "color" },
			popover: { value: "0 0% 0%", type: "color" },
			primary: { value: "9 72.4% 53.3%", type: "color" },
			secondary: { value: "9 3.8% 4.1%", type: "color" },
			muted: { value: "9 3.8% 4.1%", type: "color" },
			accent: { value: "9 3.8% 4.1%", type: "color" },
			destructive: { value: "9 72.4% 53.3%", type: "color" },
			border: { value: "0 0% 10%", type: "color" },
			input: { value: "0 0% 10%", type: "color" },
			ring: { value: "9 72.4% 53.3%", type: "color" },
			radius: { value: "2rem", type: "radius" },
