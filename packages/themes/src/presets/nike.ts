...
//
// Style reference inspired by Nike's publicly visible design system.
// Hex Core is not affiliated with, endorsed by, or sponsored by Nike.
...
export const nikeTheme: Theme = {
	...
	tokens: {
		light: {
			...
			destructive: { value: "359 100% 41.4%", type: "color" },
			...
			radius: { value: "1.875rem", type: "radius" },
			...sharedTokens,
		},
		dark: {
			...
			destructive: { value: "359 75% 58.6%", type: "color" },
