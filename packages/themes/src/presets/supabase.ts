...
//
// Style reference inspired by Supabase's publicly visible design system.
// Hex Core is not affiliated with, endorsed by, or sponsored by Supabase.
...
export const supabaseTheme: Theme = {
	...
	tokens: {
		light: {
			...
			ring: { value: "153 60.2% 52.7%", type: "color" },
			radius: { value: "0.375rem", type: "radius" },
			...sharedTokens,
		},
		dark: {
			background: { value: "0 0% 91%", type: "color" },
			foreground: { value: "0 0% 2%", type: "color" },
			card: { value: "0 0% 91%", type: "color" },
			popover: { value: "0 0% 91%", type: "color" },
			primary: { value: "153 45.1% 47.3%", type: "color" },
			secondary: { value: "153 3.8% 4.1%", type: "color" },
			muted: { value: "153 3.8% 4.1%", type: "color" },
			accent: { value: "153 3.8% 4.1%", type: "color" },
			destructive: { value: "0 48.8% 57%", type: "color" },
			border: { value: "0 0% 10%", type: "color" },
			input: { value: "0 0% 10%", type: "color" },
			ring: { value: "153 45.1% 47.3%", type: "color" },
			radius: { value: "0.375rem", type: "radius" },
