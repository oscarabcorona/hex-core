...
//
// Style reference inspired by Lamborghini's publicly visible design system.
// Hex Core is not affiliated with, endorsed by, or sponsored by Lamborghini.
...
export const lamborghiniTheme: Theme = {
	name: "lamborghini",
	...
	tokens: {
		light: {
			...
			primary: { value: "45 100% 50%", type: "color" },
			...
			ring: { value: "45 100% 50%", type: "color" },
		...
		dark: {
			...
			primary: { value: "45 75% 50%", type: "color" },
			...
			ring: { value: "45 75% 50%", type: "color" },
			radius: { value: "0rem", type: "radius" },
