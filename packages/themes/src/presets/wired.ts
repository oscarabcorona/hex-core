...
export const wiredTheme: Theme = {
	...
	tokens: {
		light: {
			...
			primary: { value: "201 94.8% 37.8%", type: "color" },
			"primary-foreground": { value: "0 0% 100%", type: "color" },
			secondary: { value: "201 5% 95.9%", type: "color" },
			"secondary-foreground": { value: "240 10% 3.9%", type: "color" },
			muted: { value: "201 5% 95.9%", type: "color" },
			"muted-foreground": { value: "0 0% 38%", type: "color" },
			accent: { value: "201 5% 95.9%", type: "color" },
			...
			ring: { value: "201 94.8% 37.8%", type: "color" },
		...
		dark: {
			...
			primary: { value: "201 71.1% 62.2%", type: "color" },
			secondary: { value: "201 3.8% 4.1%", type: "color" },
			muted: { value: "201 3.8% 4.1%", type: "color" },
			accent: { value: "201 3.8% 4.1%", type: "color" },
			destructive: { value: "0 0% 100%", type: "color" },
			border: { value: "0 0% 10%", type: "color" },
			input: { value: "0 0% 10%", type: "color" },
			ring: { value: "201 71.1% 62.2%", type: "color" },
			radius: { value: "2rem", type: "radius" },
