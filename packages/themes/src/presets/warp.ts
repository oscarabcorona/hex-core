...
//
// Style reference inspired by Warp's publicly visible design system.
// Hex Core is not affiliated with, endorsed by, or sponsored by Warp.
...
export const warpTheme: Theme = {
	...
	tokens: {
		light: {
			background: { value: "60 1% 20.6%", type: "color" },
			foreground: { value: "45 28.6% 97.3%", type: "color" },
			card: { value: "60 1% 20.6%", type: "color" },
			"card-foreground": { value: "45 28.6% 97.3%", type: "color" },
			popover: { value: "60 1% 20.6%", type: "color" },
			"popover-foreground": { value: "45 28.6% 97.3%", type: "color" },
			primary: { value: "45 28.6% 97.3%", type: "color" },
			"primary-foreground": { value: "240 10% 3.9%", type: "color" },
			secondary: { value: "45 5% 95.9%", type: "color" },
			"secondary-foreground": { value: "240 10% 3.9%", type: "color" },
			muted: { value: "45 5% 95.9%", type: "color" },
			"muted-foreground": { value: "45 8% 38%", type: "color" },
			accent: { value: "45 5% 95.9%", type: "color" },
			...
			border: { value: "45 8% 90%", type: "color" },
			input: { value: "45 8% 90%", type: "color" },
			ring: { value: "45 28.6% 97.3%", type: "color" },
			radius: { value: "0.625rem", type: "radius" },
			...sharedTokens,
		},
		dark: {
			background: { value: "60 0.8% 79.4%", type: "color" },
			foreground: { value: "45 21.5% 2.7%", type: "color" },
			card: { value: "60 0.8% 79.4%", type: "color" },
			popover: { value: "60 0.8% 79.4%", type: "color" },
			primary: { value: "45 21.5% 2.7%", type: "color" },
			secondary: { value: "45 3.8% 4.1%", type: "color" },
			muted: { value: "45 3.8% 4.1%", type: "color" },
			accent: { value: "45 3.8% 4.1%", type: "color" },
			destructive: { value: "0 48.8% 57%", type: "color" },
			border: { value: "45 6% 10%", type: "color" },
			input: { value: "45 6% 10%", type: "color" },
			ring: { value: "45 21.5% 2.7%", type: "color" },
			radius: { value: "0.625rem", type: "radius" },
