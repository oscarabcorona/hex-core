...
//
// Style reference inspired by Apple's publicly visible design system.
// Hex Core is not affiliated with, endorsed by, or sponsored by Apple.
...
export const appleTheme: Theme = {
	...
	category: "media",
	tags: ["minimalist","premium","white-space"],
	attribution: {
	...
	tokens: {
		light: {
			...
			primary: { value: "210 100% 40%", type: "color" },
			"primary-foreground": { value: "0 0% 98%", type: "color" },
			secondary: { value: "210 5% 95.9%", type: "color" },
			"secondary-foreground": { value: "240 10% 3.9%", type: "color" },
			muted: { value: "210 5% 95.9%", type: "color" },
			"muted-foreground": { value: "0 0% 38%", type: "color" },
			accent: { value: "210 5% 95.9%", type: "color" },
			...
			ring: { value: "210 100% 40%", type: "color" },
		...
		dark: {
			...
			primary: { value: "210 75% 60%", type: "color" },
			secondary: { value: "210 3.8% 4.1%", type: "color" },
			muted: { value: "210 3.8% 4.1%", type: "color" },
			accent: { value: "210 3.8% 4.1%", type: "color" },
			destructive: { value: "0 48.8% 57%", type: "color" },
			border: { value: "0 0% 10%", type: "color" },
			input: { value: "0 0% 10%", type: "color" },
			ring: { value: "210 75% 60%", type: "color" },
			radius: { value: "2rem", type: "radius" },
