...
//
// Style reference inspired by xAI's publicly visible design system.
// Hex Core is not affiliated with, endorsed by, or sponsored by xAI.
...
export const xTheme: Theme = {
	...
	tokens: {
		light: {
			background: { value: "220 12.7% 13.9%", type: "color" },
			foreground: { value: "0 0% 100%", type: "color" },
			card: { value: "220 12.7% 13.9%", type: "color" },
			"card-foreground": { value: "0 0% 100%", type: "color" },
			popover: { value: "220 12.7% 13.9%", type: "color" },
		...
		dark: {
			background: { value: "220 9.5% 86.1%", type: "color" },
			foreground: { value: "0 0% 0%", type: "color" },
			card: { value: "220 9.5% 86.1%", type: "color" },
			popover: { value: "220 9.5% 86.1%", type: "color" },
