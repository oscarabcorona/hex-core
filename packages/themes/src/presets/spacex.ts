...
//
// Style reference inspired by SpaceX's publicly visible design system.
// Hex Core is not affiliated with, endorsed by, or sponsored by SpaceX.
...
export const spacexTheme: Theme = {
	name: "spacex",
	displayName: "SpaceX",
	...
	tokens: {
		light: {
			...
			foreground: { value: "240 50% 96.1%", type: "color" },
			card: { value: "0 0% 0%", type: "color" },
			"card-foreground": { value: "240 50% 96.1%", type: "color" },
			popover: { value: "0 0% 0%", type: "color" },
			"popover-foreground": { value: "240 50% 96.1%", type: "color" },
		...
		dark: {
			...
			foreground: { value: "240 37.5% 3.9%", type: "color" },
