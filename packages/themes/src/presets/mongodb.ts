...
//
// Style reference inspired by MongoDB's publicly visible design system.
// Hex Core is not affiliated with, endorsed by, or sponsored by MongoDB.
...
export const mongodbTheme: Theme = {
	name: "mongodb",
	displayName: "MongoDB",
	...
	tokens: {
		light: {
			background: { value: "204 33.3% 16.5%", type: "color" },
			foreground: { value: "0 0% 95%", type: "color" },
			card: { value: "204 33.3% 16.5%", type: "color" },
			"card-foreground": { value: "0 0% 95%", type: "color" },
			popover: { value: "204 33.3% 16.5%", type: "color" },
			"popover-foreground": { value: "0 0% 95%", type: "color" },
			primary: { value: "145 100% 46.5%", type: "color" },
			"primary-foreground": { value: "240 10% 3.9%", type: "color" },
			secondary: { value: "145 5% 95.9%", type: "color" },
			"secondary-foreground": { value: "240 10% 3.9%", type: "color" },
			muted: { value: "145 5% 95.9%", type: "color" },
			"muted-foreground": { value: "0 0% 38%", type: "color" },
			accent: { value: "145 5% 95.9%", type: "color" },
			...
			ring: { value: "145 100% 46.5%", type: "color" },
			radius: { value: "2rem", type: "radius" },
			...sharedTokens,
		},
		dark: {
			background: { value: "204 25% 83.5%", type: "color" },
			foreground: { value: "0 0% 5%", type: "color" },
			card: { value: "204 25% 83.5%", type: "color" },
			popover: { value: "204 25% 83.5%", type: "color" },
			primary: { value: "145 75% 53.5%", type: "color" },
			secondary: { value: "145 3.8% 4.1%", type: "color" },
			muted: { value: "145 3.8% 4.1%", type: "color" },
			accent: { value: "145 3.8% 4.1%", type: "color" },
			destructive: { value: "0 48.8% 57%", type: "color" },
			border: { value: "0 0% 10%", type: "color" },
			input: { value: "0 0% 10%", type: "color" },
			ring: { value: "145 75% 53.5%", type: "color" },
			radius: { value: "2rem", type: "radius" },
