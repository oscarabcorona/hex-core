...
//
// Style reference inspired by Together AI's publicly visible design system.
// Hex Core is not affiliated with, endorsed by, or sponsored by Together AI.
...
export const togetherTheme: Theme = {
	name: "together",
	...
	tokens: {
		light: {
			...
			primary: { value: "314 85.9% 55.5%", type: "color" },
			"primary-foreground": { value: "240 10% 3.9%", type: "color" },
			secondary: { value: "314 5% 95.9%", type: "color" },
			"secondary-foreground": { value: "240 10% 3.9%", type: "color" },
			muted: { value: "314 5% 95.9%", type: "color" },
			"muted-foreground": { value: "240 8% 38%", type: "color" },
			accent: { value: "314 5% 95.9%", type: "color" },
			...
			ring: { value: "314 85.9% 55.5%", type: "color" },
		...
		dark: {
			...
			primary: { value: "314 64.4% 44.5%", type: "color" },
			secondary: { value: "314 3.8% 4.1%", type: "color" },
			muted: { value: "314 3.8% 4.1%", type: "color" },
			accent: { value: "314 3.8% 4.1%", type: "color" },
			destructive: { value: "0 48.8% 57%", type: "color" },
			border: { value: "240 6% 10%", type: "color" },
			input: { value: "240 6% 10%", type: "color" },
			ring: { value: "314 64.4% 44.5%", type: "color" },
			radius: { value: "0.25rem", type: "radius" },
