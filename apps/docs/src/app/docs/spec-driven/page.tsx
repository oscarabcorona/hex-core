...
export const metadata = {
	title: "Spec-driven",
	description:
		"Turn a brief or spec.md into a checklist-driven component build. Four MCP tools, eight recipes, no runtime service.",
};
...
const RECIPES = [
	...
	{ slug: "landing-hero", title: "Landing hero", summary: "Headline + subhead + CTA + count-up stats from the motion catalog." },
];
...
export default function SpecDrivenPage() {
	return (
		<DocsPage
			...
			description="Turn a brief or a spec.md section into a checklist-driven build. Four MCP tools, eight recipes, no runtime service."
			sections={SECTIONS}
